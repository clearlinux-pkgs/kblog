...
Version  : 19.12.2
Release  : 18
URL      : https://download.kde.org/stable/release-service/19.12.2/src/kblog-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kblog-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kblog-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kblog-19.12.2
cd %{_builddir}/kblog-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581016026
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kblog-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kblog/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang libkblog5
