...
Version  : 19.12.3
Release  : 19
URL      : https://download.kde.org/stable/release-service/19.12.3/src/kblog-19.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kblog-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kblog-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kblog-19.12.3
cd %{_builddir}/kblog-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583438209
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kblog-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kblog/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang libkblog5
...
/usr/lib64/libKF5Blog.so.5.13.3
