...
Version  : 19.04.1
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.1/src/kblog-19.04.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.1/src/kblog-19.04.1.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.1/src/kblog-19.04.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557444930
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5Blog.so.5.11.1
